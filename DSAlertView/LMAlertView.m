...
//	[_alertBackgroundView addSubview:imageView];
    ...
    [self.alertContainerView addGestureRecognizer:({
...
- (void)tapAction:(UITapGestureRecognizer *)sender {
    if (self.isTapNotCancel) {
        CGPoint tapPoint = [sender locationInView:_alertContainerView];
        CGPoint newPoint = [_alertContainerView convertPoint:tapPoint toView:_representationView];
        if ([self.representationView pointInside:newPoint withEvent:nil]) {
